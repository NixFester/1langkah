...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
            ...
            <p class="text-3xl sm:text-4xl font-bold mb-1">Rp {{ number_format($todayRevenue, 0, ',', '.') }}</p>
            <p class="text-green-100 text-sm">{{ $stats['approved_today'] }} {{ __('app.successful_transactions') }}</p>
        </div>

        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-blue-100 font-medium">{{ __('app.month_revenue') }}</h2>
                <svg class="w-8 h-8 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
            </div>
            <p class="text-3xl sm:text-4xl font-bold mb-1">Rp {{ number_format($monthRevenue, 0, ',', '.') }}</p>
