            ...
            <a :href="'/kursus/' + course.id" class="bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-lg transition-all duration-300 group flex flex-col h-full">
                ...
                <div class="p-4 flex flex-col flex-grow">
                    ...
                    <div class="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                        ...
                        <span class="text-base font-bold text-gray-900" x-text="!course.price || course.price == 0 || course.price.toString().toLowerCase() === 'gratis' ? '{{ __('app.free') }}' : (!isNaN(course.price) ? 'Rp ' + new Intl.NumberFormat('id-ID').format(course.price) : course.price)"></span>
                    </div>
                </div>
            </a>
        </template>
