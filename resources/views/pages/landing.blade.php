...
<div class="min-h-screen w-full flex flex-col overflow-x-hidden bg-[#050304]">
    ...
    <!-- Hero -->
    <section class="relative flex-1 w-full flex flex-col justify-center px-6 md:px-12 pt-28 pb-10 z-10">
    <!-- Red gradient glow in background -->
    <div class="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-[#D10000]/15 rounded-full blur-[120px] -translate-y-1/2 pointer-events-none"></div>
    ...
    <div class="max-w-[1400px] mx-auto w-full relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative z-10 flex flex-col items-start">
                ...
                <!-- Badge -->
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-red-900/40 bg-[#D10000]/10 mb-5">
                    ...
                    <span class="text-[11px] sm:text-xs font-bold tracking-[0.15em] text-[#ef4444] uppercase">AI-POWERED LEARNING EXPERIENCE PLATFORM</span>
                </div>

                <!-- Title -->
                <h1 class="text-5xl sm:text-6xl md:text-[76px] font-extrabold leading-[1.05] tracking-tight text-white mb-5">
                    Satu Langkah<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#FF3333] to-[#FF8C00]">Menuju Masa</span><br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#FF3333] to-[#FF8C00]">Depan</span><br>
                    Lebih Baik.
                </h1>

                <!-- Subtitle -->
                <p class="text-lg md:text-xl text-[#9ca3af] mb-8 max-w-[500px] leading-relaxed">
                ...
                <div class="flex flex-wrap items-center gap-5 mb-3">
                    <a href="{{ route('signup') }}" class="inline-flex items-center gap-2.5 px-8 py-4 bg-[#D10000] text-white font-bold rounded-2xl hover:bg-[#b30000] transition-all shadow-[0_0_40px_rgba(209,0,0,0.6)]">
                    ...
                    <a href="{{ route('kursus') }}" class="inline-flex items-center justify-center px-8 py-4 border border-white/10 bg-transparent text-white font-bold rounded-2xl hover:bg-white/5 transition-colors">
                        Jelajahi Kursus
                    </a>
                </div>
            ...
            <div class="relative z-10 hidden lg:flex items-center justify-center w-full">
                <div class="relative w-full max-w-[700px] xl:max-w-[760px] mx-auto">
                    <!-- Floating Pills -->
                    <div class="absolute left-[5%] top-[25%] px-5 py-2 bg-[#171313]/90 backdrop-blur-sm border border-white/10 rounded-full text-white text-[13px] font-semibold z-30 shadow-2xl animate-[float_7s_ease-in-out_infinite]">React</div>
                    <div class="absolute left-[8%] top-[45%] px-5 py-2 bg-[#171313]/90 backdrop-blur-sm border border-white/10 rounded-full text-white text-[13px] font-semibold z-30 shadow-2xl animate-[float_8s_ease-in-out_infinite_reverse]">Python</div>
        ...
        <!-- Bottom Stats Row -->
        <div class="mt-20 xl:mt-24 mb-12 xl:mb-16 flex flex-col md:flex-row items-center justify-between gap-10">
            <div class="flex flex-wrap items-center justify-center md:justify-start gap-12 md:gap-16">
                <div class="text-center md:text-left">
                    <div class="text-[26px] font-bold text-white mb-1 tracking-tight">100K+</div>
                    <div class="text-[13px] font-medium text-[#6b7280]">Pelajar Aktif</div>
                </div>
                <div class="text-center md:text-left">
                    <div class="text-[26px] font-bold text-white mb-1 tracking-tight">800+</div>
                    <div class="text-[13px] font-medium text-[#6b7280]">Kursus Premium</div>
                </div>
                <div class="text-center md:text-left">
                    <div class="text-[26px] font-bold text-white mb-1 tracking-tight">500+</div>
                    <div class="text-[13px] font-medium text-[#6b7280]">Mentor Berpengalaman</div>
                </div>
                <div class="text-center md:text-left">
                    <div class="text-[26px] font-bold text-white mb-1 tracking-tight">95%</div>
                    <div class="text-[13px] font-medium text-[#6b7280]">Course Completion</div>
                </div>
            </div>
    ...
    <!-- Partners -->
    <section class="py-6 xl:py-8 px-6 md:px-12 bg-transparent border-t border-white/5 relative z-20">
        <div class="max-w-[1400px] mx-auto text-center">
            <p class="text-[11px] font-bold tracking-[0.2em] text-[#6b7280] uppercase mb-6">DIPERCAYA OLEH 300+ PERUSAHAAN & INSTITUSI TERKEMUKA</p>
        <div class="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60">
            <span class="text-xl font-bold text-[#9ca3af]">GOJEK</span>
            <span class="text-xl font-bold text-[#9ca3af]">SHOPEE</span>
            <span class="text-xl font-bold text-[#9ca3af]">TRAVELOKA</span>
            <span class="text-xl font-bold text-[#9ca3af]">GRAB</span>
            <span class="text-xl font-bold text-[#9ca3af]">BUKALAPAK</span>
            <span class="text-xl font-bold text-[#9ca3af]">PERTAMINA</span>
            <span class="text-xl font-bold text-[#9ca3af]">BCA</span>
            <span class="text-xl font-bold text-[#9ca3af]">TELKOM</span>
            <span class="text-xl font-bold text-[#9ca3af]">BLIBLI</span>
        </div>
    </section>
</div>

<!-- Features (Section 2) -->
<section id="features" class="py-24 bg-white relative w-full overflow-hidden">
    <div class="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-4xl md:text-[44px] font-extrabold text-[#0f172a] tracking-tight leading-[1.2] mb-4">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#FF3333] to-[#FF8C00]">Ini ekosistem karir kamu.</span>
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
            <!-- Card 1 -->
            <div class="bg-white rounded-[2rem] p-8 lg:p-10 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all flex flex-col items-start group cursor-pointer">
