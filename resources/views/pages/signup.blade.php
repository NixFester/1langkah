...
<div class="min-h-screen lg:h-screen w-full flex bg-[#f7f8f9] lg:overflow-hidden">
    ...
    <div class="w-full md:w-[50%] flex items-center justify-center p-6 md:p-10 relative lg:overflow-y-auto lg:h-full">
        ...
        <div class="w-full max-w-[480px] bg-white rounded-[32px] p-8 lg:p-8 shadow-[0_24px_60px_rgba(0,0,0,0.06)] border border-gray-100 my-8 lg:my-4">
            ...
            <!-- Google Sign Up -->
            <button type="button" class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-200 rounded-full hover:bg-gray-50 transition-colors mb-5 shadow-sm">
