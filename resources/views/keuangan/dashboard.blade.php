    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 relative overflow-hidden">
            <div class="relative z-10 flex items-center justify-between mb-4">
                <h2 class="text-gray-500 font-medium">{{ __('app.today_revenue') }}</h2>
            ...
            <p class="relative z-10 text-3xl sm:text-4xl font-bold mb-1 text-gray-900">Rp {{ number_format($todayRevenue, 0, ',', '.') }}</p>
            <p class="relative z-10 text-gray-500 text-sm">{{ $stats['approved_today'] }} {{ __('app.successful_transactions') }}</p>
        </div>

        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 relative overflow-hidden">
            <div class="relative z-10 flex items-center justify-between mb-4">
                <h2 class="text-gray-500 font-medium">{{ __('app.month_revenue') }}</h2>
            ...
            <p class="relative z-10 text-3xl sm:text-4xl font-bold mb-1 text-gray-900">Rp {{ number_format($monthRevenue, 0, ',', '.') }}</p>
            <p class="relative z-10 text-gray-500 text-sm">{{ __('app.total_month_revenue') }}</p>
        </div>
    </div>
