...
<div class="flex md:hidden h-[100dvh] w-full flex-col bg-gradient-to-br from-[#fff1f1] to-[#f7f8f9] overflow-hidden">
    <div class="w-full h-full overflow-y-auto flex flex-col px-6 py-8 mx-auto items-center">
        <div class="my-auto flex flex-col items-center justify-center w-full max-w-[420px] pb-8">
    <!-- Logo & Header -->
    ...
    <div class="w-full bg-white rounded-3xl p-7 shadow-sm border border-gray-100">
        ...
        <form method="POST" action="{{ route('login.submit') }}">
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password" required placeholder="••••••••" class="w-full px-5 py-3 bg-[#f9fafb] border border-gray-200 rounded-xl text-[20px] text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-[#cc0000] transition-all placeholder:text-gray-300 placeholder:tracking-[0.2em] placeholder:text-[16px] tracking-widest">
            </div>
...
<div class="hidden md:flex min-h-screen lg:h-screen w-full bg-[#f7f8f9] lg:overflow-hidden">
    ...
    <div class="hidden md:flex flex-col w-[50%] bg-[#080202] relative p-10 lg:p-14 overflow-hidden border-r border-white/5">
        ...
        <!-- Subtle Red Glow -->
        <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-[#990000]/20 blur-[130px] rounded-full pointer-events-none -translate-y-1/2 translate-x-1/3"></div>
        ...
        <div class="relative z-10 flex-1 flex flex-col justify-center">
            ...
            <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-[#5c1313] bg-[#3a0808] w-fit mb-6">
                <svg class="w-3.5 h-3.5 text-[#ff6b6b]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l2.4 7.6h8l-6.4 4.8 2.4 7.6-6.4-4.8-6.4 4.8 2.4-7.6-6.4-4.8h8z"/></svg>
                <span class="text-[12px] font-semibold text-[#ff6b6b]">AI-Powered Learning Platform</span>
            </div>
            ...
            <p class="text-[15px] text-gray-400 leading-relaxed max-w-[420px] mb-12">
                Bergabung dengan 100,000+ pelajar yang sudah membuktikan<br>hasilnya bersama 1Langkah.
            </p>
